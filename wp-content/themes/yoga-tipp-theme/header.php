...
<body <?php body_class('antialiased'); ?> id="page">
...
<div class="container" role="document">
	<section id="logo" class="row">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
						<div id="title" class="flower-orange-page"><h1 class="home-title">Grainne <br> McLaughlin <br>Yoga</h1></div>
						<div id="yantra" class="flower-orange-page"><img src="http://visiblesandbox.com/grainne/wp-content/uploads/2015/12/The_Sri_Yantra-160.svg"></div>
					</a>
